...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_FILES['gambar-baru']) && $_FILES['gambar-baru']['error'] == 0) {
        ...
        $admin->EditBuku($ext, $gambar_tmp, $id_buku, $judul, $penulis, $penerbit, $tahun, $sinopsis, $nama_kategori, $bahasa, $jumlah_halaman, null, $stok);
    } else {
        ...
        $admin->EditBuku(null, null, $id_buku, $judul, $penulis, $penerbit, $tahun, $sinopsis, $nama_kategori, $bahasa, $jumlah_halaman, $gambar, $stok);
    }
...
<body>
    ...
    <div class="container">
        ...
        <form class="form" method="POST" enctype="multipart/form-data" action="" name="upload">
            ...
            <input value="<?php foreach ($buku_edit as $buku) {
                                echo $buku['stok'];
                            } ?>" min="1" max="10000" type="number" name="stok" placeholder="stok" class="halaman" required>
