...
<body>
    ...
    <div class="message-container"
        style="<?php echo isset($_SESSION['message']) && strpos($_SESSION['message'], 'gagal') !== false ? 'background-color: red;' : (isset($_SESSION['message']) && strpos($_SESSION['message'], 'berhasil') !== false ? 'background-color: green;' : ''); ?>">
        <?php
    ...
    <div class="container">
        ...
        <form class="form" method="POST" enctype="multipart/form-data" action="" name="upload">
            ...
            <input min="1" max="10000" type="number" name="halaman" placeholder="Jumlah Halaman" class="halaman"
                required>
